...
def get_user_with_tier_from_query(
    user: Annotated[dict, Depends(get_firebase_user_from_query_token)],
) -> dict:
    """
...
def get_user_with_tier_from_either(
    user: Annotated[dict, Depends(get_firebase_user_from_either)],
) -> dict:
    """
