...
class LoginSchema(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {"email": "sample@gmail.com", "password": "samplepass123"}
        }
...
class OutcomeLine(BaseModel):
    ...
    history_by_sportsbook: dict[str, list[LineDataPoint]] | None = (
        None  # Optional: grouped by sportsbook
    )
        ...
        json_schema_extra = {
            "example": {
                ...
                "history_by_sportsbook": {
                    ...
                    "FanDuel": [
                        {"odds": -110, "sportsbook": "FanDuel", "timestamp": 1704461400}
                    ],
                },
            }
        }
